...
var residency = {
    ...
    Show: function () {
        ...
        $('#drag').width('580px');
        // 鼠标悬停变色
        $('#residencyAlpha li').hover(function () {
            $(this).addClass('over')
        }, function () {
            $(this).removeClass()
        });
...
var jobArea = {
    ...
    Show: function () {
        ...
        $('#drag').width('580px');
        // 鼠标悬停变色
        $('#jobAreaAlpha li').hover(function () {
            $(this).addClass('over')
        }, function () {
    ...
    Chk: function (id) {
        if (!in_array(id, jobArea_Arr)) {
            ...
            if (jobArea_Arr.length < 50) {
                ...
                $('#jobAreSelected li').hover(function () {
                    $(this).addClass('over')
                }, function () {
                    $(this).removeClass('over')
                });
...
function jobAreaSelect() {
    ...
    dragHtml += '</div>';
    $('#drag_h').html('<b>请选择地区（您最多能选择5项）</b><span class="arg-change" onclick="jobArea.confirm()">确定</span>');
    $('#drag_con').html(dragHtml);
