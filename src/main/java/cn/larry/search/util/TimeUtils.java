...
public class TimeUtils {
    ...
    public static void main(String[] args) {
        String time = "2016-06-23 13:41:20:0";
        LocalDateTime ldt = parseLocalDateTime(time);
        System.out.println();
    }
    ...
    public static LocalDateTime parseLocalDateTime(String date) {
        try {
            ...
            if (date.length() >= 18) {
                ...
                LocalDateTime ldt = LocalDateTime.of(year, month, dat, hour, min, second);
                return ldt;
            } else {
    ...
    public static String formatSolrStyleDate(Date date) {
